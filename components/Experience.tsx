  ...
  const experiences = [
    {
      ...
      company: t("ministry.company"),
      period: t("ministry.period"),
      description: t("ministry.desc"),
      technologies: ["AngularJS", "Laravel", "MySQL", "Full-Stack"],
    },
    {
      type: "work" as const,
      title: t("lotus.title"),
      company: t("lotus.company"),
      period: t("lotus.period"),
      description: t("lotus.desc"),
      technologies: [
        "React.js",
        "Leaflet",
        "TypeScript",
    ...
    },
    {
      type: "work" as const,
      title: t("boxit.title"),
      company: t("boxit.company"),
      period: t("boxit.period"),
      description: t("boxit.desc"),
      technologies: ["React.js", "Leaflet", "Admin Panels", "Formic"],
    },
    {
      type: "work" as const,
      title: t("taraz.title"),
      company: t("taraz.company"),
      period: t("taraz.period"),
      description: t("taraz.desc"),
      technologies: [
        "React.js",
        "SASS",
        "Responsive Design",
    ...
    },
    {
      ...
      company: t("masters.company"),
      period: t("masters.period"),
    ...
    },
    {
      ...
      company: t("bachelor.company"),
      period: t("bachelor.period"),
      description: t("bachelor.desc"),
      technologies: [
        "Information Technology",
        "Databases",
        "Networking",
